...
class ApiContainer extends Component {
    ...
    goForFetch = () => {
        ...
        fetch("https://recipe.christiandurazo.com/getRecipes")
    ...
    goForAxios = () => {
        ...
        axios.get("https://recipe.christiandurazo.com/getRecipes")
            .then(response => {
    ...
    renderItem = (data) => {
        return (
            <TouchableOpacity style={styles.list}>
                ...
                <Text style={styles.lightText}>{data.item.rating}</Text></TouchableOpacity>
        )
